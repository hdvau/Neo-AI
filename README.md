...
```
user@neo [ollama:mistral:latest] >
```
...
```
user@neo [claude:claude-opus-4-5] > find the document "report.pdf" and copy it to Downloads
...
Neo:  Found it at /Users/user/Documents/report.pdf. Copying it to Downloads now.
